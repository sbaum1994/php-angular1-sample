...
// OpenTracing Begin Block --
LightStep::initGlobalTracer('proxy-api', '{ACCESS_TOKEN_HERE}');
// OpenTracing End Block --
...
function makeRequest($url) {
  ...
  $span = $tracer->join("makeRequest", LIGHTSTEP_FORMAT_TEXT_MAP, getallheaders());
  $span->setTag("url", $url);
  // OpenTracing End Block --
  ...
  // OpenTracing Begin Block --
  $span->logEvent("responseBody", $responseBody);
  $span->finish();
  // OpenTracing End Block --
